    ...
    <div class="container">
        <div class="row justify-content-between flex-lg-row flex-column">
            <div class="col col-lg-2">
                ...
                <img width="60" height="49" srcset="http://www.elloe.ai/wp-content/uploads/2024/04/full.png 475w, http://www.elloe.ai/wp-content/uploads/2024/04/full.png 100w" class="company__logo d-block adjustable-element ls-is-cached lazyloaded" alt="logo" data-lazy="true" decoding="async" loading="lazy">
                    <div class="main-footer__company c-pb-lg-3 c-pb-6">
                        <div class="company__details entry-content"><p><strong>Elloe<br/>
...
<div class="main-footer__menu-wrapper">
    ...
    <div class="col-auto c-py-6 c-py-lg-0 main-footer__secondary-menu-wrapper order-lg-3">
        ...
        <div class="col-auto order-lg-2 c-pb-3 c-pb-lg-0 line-height-1-1 line-height-lg-1-7 align-items-center d-flex">
            <span class="main-footer__copyrights font-size-13 text-gray">Elloe © All Rights Reserved</span>
        </div>
    </div>
</div>
</footer>
